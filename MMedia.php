...
foreach ($body as $val) {
    ...
    <small style="text-align: center;display: inline-block;width: 100%;"><?php echo $mmedia_user->user->name ?? "You are not currently logged in via M Media"; ?></small>
</div>
<?php
    }
    /**
